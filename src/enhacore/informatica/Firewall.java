...
public class Firewall extends JFrame {
	...
	public Firewall() {
		...
		JLabel lblAnthropology = new JLabel("Firewall:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(142, 27, 76, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Cortafuegos");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(142, 94, 89, 23);
