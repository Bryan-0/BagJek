...
public class Password extends JFrame {
	...
	public Password() {
		...
		JLabel lblAnthropology = new JLabel("Password:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(136, 24, 91, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Contraseña");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(136, 93, 82, 23);
