...
public class Gigabyte extends JFrame {
	...
	public Gigabyte() {
		...
		JLabel lblAnthropology = new JLabel("Gigabyte:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(134, 22, 89, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("1024 Kilobytes");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(128, 92, 109, 23);
