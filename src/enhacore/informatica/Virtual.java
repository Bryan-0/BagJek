...
public class Virtual extends JFrame {
	...
	public Virtual() {
		...
		JLabel lblAnthropology = new JLabel("Virtual:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(142, 24, 76, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Virtual");
