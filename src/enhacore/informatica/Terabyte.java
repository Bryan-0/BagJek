...
public class Terabyte extends JFrame {
	...
	public Terabyte() {
		...
		JLabel lblAnthropology = new JLabel("Terabyte:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(137, 24, 97, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("1024 Gigabytes");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(124, 93, 110, 23);
