...
public class Backup extends JFrame {
	...
	public Backup() {
		...
		JLabel lblAnthropology = new JLabel("Backup:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(149, 25, 80, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Copia");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(160, 93, 63, 23);
