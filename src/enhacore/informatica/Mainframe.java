...
public class Mainframe extends JFrame {
	...
	public Mainframe() {
		...
		JLabel lblAnthropology = new JLabel("Mainframe:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(129, 24, 101, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Procesador Central");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(110, 93, 139, 23);
