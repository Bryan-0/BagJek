...
public class File extends JFrame {
	...
	public File() {
		...
		JLabel lblAnthropology = new JLabel("File:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(155, 24, 43, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Archivo");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(145, 93, 63, 23);
