...
public class Data extends JFrame {
	...
	public Data() {
		...
		JLabel lblAnthropology = new JLabel("Data:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(155, 32, 63, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Información");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(138, 93, 89, 23);
