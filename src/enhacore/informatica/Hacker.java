...
public class Hacker extends JFrame {
	...
	public Hacker() {
		...
		JLabel lblAnthropology = new JLabel("Hacker:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(143, 25, 75, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Cortador");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(143, 92, 63, 23);
