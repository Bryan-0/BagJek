...
public class Compile extends JFrame {
	...
	public Compile() {
		...
		JLabel lblAnthropology = new JLabel("Compile:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(138, 23, 79, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Compilar");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(138, 96, 69, 23);
