...
public class Markup extends JFrame {
	...
	public Markup() {
		...
		JLabel lblAnthropology = new JLabel("Markup:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(135, 24, 83, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Marcado");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(143, 93, 63, 23);
