...
public class Keyboard extends JFrame {
	...
	public Keyboard() {
		...
		JLabel lblAnthropology = new JLabel("Keyboard:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(135, 23, 97, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Teclado");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(145, 95, 63, 23);
