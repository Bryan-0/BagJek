...
public class Cloud extends JFrame {
	...
	public Cloud() {
		...
		JLabel lblAnthropology = new JLabel("Cloud:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(159, 32, 63, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Nube");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(171, 94, 46, 23);
