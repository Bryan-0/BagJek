...
public class Template extends JFrame {
	...
	public Template() {
		...
		JLabel lblAnthropology = new JLabel("Template:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(129, 24, 104, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Templado");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(129, 92, 89, 23);
