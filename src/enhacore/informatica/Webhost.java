...
public class Webhost extends JFrame {
	...
	public Webhost() {
		...
		JLabel lblAnthropology = new JLabel("Webhost:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(129, 24, 89, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Anfitrión de Web");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(108, 93, 128, 23);
