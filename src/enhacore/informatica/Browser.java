...
public class Browser extends JFrame {
	...
	public Browser() {
		...
		JLabel lblAnthropology = new JLabel("Browser:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(155, 24, 79, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Navegador");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(155, 93, 79, 23);
