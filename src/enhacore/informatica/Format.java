...
public class Format extends JFrame {
	...
	public Format() {
		...
		JLabel lblAnthropology = new JLabel("Format:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(140, 27, 78, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Formato");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(144, 92, 63, 23);
