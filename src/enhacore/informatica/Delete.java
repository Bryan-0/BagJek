...
public class Delete extends JFrame {
	...
	public Delete() {
		...
		JLabel lblAnthropology = new JLabel("Delete:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(140, 25, 66, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Borrar");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(154, 95, 52, 23);
