...
public class Desktop extends JFrame {
	...
	public Desktop() {
		...
		JLabel lblAnthropology = new JLabel("Desktop:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(147, 25, 80, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Escritorio");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(155, 93, 72, 23);
