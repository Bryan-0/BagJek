...
public class Operating extends JFrame {
	...
	public Operating() {
		...
		JLabel lblAnthropology = new JLabel("Operating:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(137, 24, 106, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Operando");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(137, 94, 81, 23);
