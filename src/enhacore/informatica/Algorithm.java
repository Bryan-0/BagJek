...
public class Algorithm extends JFrame {
	...
	public Algorithm() {
		...
		JLabel lblAnthropology = new JLabel("Algorithm:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(138, 32, 100, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Algoritmo");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(148, 100, 79, 23);
