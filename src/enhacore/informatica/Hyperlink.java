...
public class Hyperlink extends JFrame {
	...
	public Hyperlink() {
		...
		JLabel lblAnthropology = new JLabel("Hyperlink:");
		lblAnthropology.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAnthropology.setBounds(133, 30, 103, 30);
		contentPane.add(lblAnthropology);
		
		JLabel lblAntropologa = new JLabel("Hiper Vínculo");
		lblAntropologa.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblAntropologa.setBounds(133, 86, 103, 23);
